...
const Customizer = (props: any) => {
  ...
  const renderFooterTypeRadio = () => {
    ...
    return footerTypeArr.map((radio, index) => {
      ...
      return (
        <div key={index} className={classnames('form-check', { 'mb-2 me-1': marginCondition })}>
          <Input type="radio" checked={radio.checked} id={`footer-${radio.name}`} onChange={() => setFooterType(radio.name)} />
          ...
          <div className="mb-2">
            ...
            <div className="d-flex">
              <div className="form-check me-1">
                <Input type="radio" id="full-width" checked={contentWidth === 'full'} onChange={() => setContentWidth('full')} />
                <Label className="form-check-label" for="full-width">
                  Full Width
                </Label>
              </div>
              <div className="form-check">
                <Input id="boxed" type="radio" checked={contentWidth === 'boxed'} onChange={() => setContentWidth('boxed')} />
